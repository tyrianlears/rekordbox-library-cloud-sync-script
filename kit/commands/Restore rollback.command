#!/bin/bash
# Undo the last restore — double-click to run. Same action as the button in "rekordbox Backup.app".
...
clear; echo "▶ Undo the last restore"; echo
/bin/bash "$S" --rollback; RC=$?
