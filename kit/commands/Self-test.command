#!/bin/bash
# Self-test — double-click to run. Same action as the button in "rekordbox Backup.app".
...
if [ -x "$KIT_BIN/rbk-selftest.sh" ]; then S="$KIT_BIN/rbk-selftest.sh"; else S="$HERE/rbk-selftest.sh"; fi
clear; echo "▶ Self-test"; echo
/bin/bash "$S" ; RC=$?
